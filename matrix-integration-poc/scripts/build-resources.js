...
// "dest/b/...".
const COPY_LIST = [
    // ["res/manifest.json", "public"],
    // ["res/sw.js", "public"],
    // ["res/welcome.html", "public"],
    // ["res/welcome/**", "public/welcome"],
    // ["res/themes/**", "public/themes"],
    // ["res/vector-icons/**", "public/vector-icons"],
    // ["res/decoder-ring/**", "public/decoder-ring"],
    ["node_modules/matrix-react-sdk/res/media/**", "public/media"],
    // ["node_modules/olm/olm_legacy.js", "public", { directwatch: 1 }],
    // ["./config.json", "public", { directwatch: 1 }],
    // ["contribute.json", "public"],
];
...
function genLangList(langFileMap) {
    ...
    fs.writeFile('public/i18n/languages.json', JSON.stringify(languages, null, 4), function(err) {
        if (err) {
